...
const CurrentForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `<div class="${"current-form-row"}"><div class="${"icon pos-0 " + escape(data.form[fullTeamName][currentMatchday].form5.charAt(0)) + " " + escape(data.form[fullTeamName][matchdays[0]].beatStarTeam
		? 'star-team'
		: '')}"></div>
    <div class="${"icon pos-1 " + escape(data.form[fullTeamName][currentMatchday].form5.charAt(1)) + " " + escape(data.form[fullTeamName][matchdays[1]].beatStarTeam
		? 'star-team'
		: '')}"></div>
    <div class="${"icon pos-2 " + escape(data.form[fullTeamName][currentMatchday].form5.charAt(2)) + " " + escape(data.form[fullTeamName][matchdays[2]].beatStarTeam
		? 'star-team'
		: '')}"></div>
    <div class="${"icon pos-3 " + escape(data.form[fullTeamName][currentMatchday].form5.charAt(3)) + " " + escape(data.form[fullTeamName][matchdays[3]].beatStarTeam
		? 'star-team'
		: '')}"></div>
    <div class="${"icon pos-4 " + escape(data.form[fullTeamName][currentMatchday].form5.charAt(4)) + " " + escape(data.form[fullTeamName][matchdays[4]].beatStarTeam
		? 'star-team'
		: '')}"></div></div>

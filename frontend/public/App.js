...
const css$c = {
	code: "#formTile.svelte-1doaosm{width:100%;height:100%;aspect-ratio:1/1;border-radius:6px;color:#2b2d2f;display:grid;place-items:center;border:3px #333333 solid}.result.svelte-1doaosm{margin-top:0.14em;font-size:2vw}@media only screen and (max-width: 1100px){.result.svelte-1doaosm{font-size:3em}}@media only screen and (max-width: 600px){.result.svelte-1doaosm{font-size:7vw;margin-top:0.25em}}",
	map: "{\"version\":3,\"file\":\"FormTile.svelte\",\"sources\":[\"FormTile.svelte\"],\"sourcesContent\":[\"<script lang=\\\"ts\\\">function background(result, starTeam) {\\r\\n    if (starTeam) {\\r\\n        return \\\"linear-gradient(red, blue, green)\\\";\\r\\n    }\\r\\n    switch (result) {\\r\\n        case \\\"W\\\":\\r\\n            return \\\"#77dd77\\\";\\r\\n        case \\\"D\\\":\\r\\n            return \\\"#ffb347\\\";\\r\\n        case \\\"L\\\":\\r\\n            return \\\"#c23b22\\\";\\r\\n        default:\\r\\n            return \\\"transparent\\\";\\r\\n    }\\r\\n}\\r\\nfunction formatResult(result) {\\r\\n    switch (result) {\\r\\n        case \\\"W\\\":\\r\\n        case \\\"D\\\":\\r\\n        case \\\"L\\\":\\r\\n            return result;\\r\\n        default:\\r\\n            return \\\"\\\";\\r\\n    }\\r\\n}\\r\\nexport let result, starTeam;\\r\\n</script>\\r\\n\\r\\n<div\\r\\n  id=\\\"formTile\\\"\\r\\n  style=\\\"background: {background(result, starTeam)}\\\"\\r\\n>\\r\\n  <div class=\\\"result\\\">\\r\\n    {formatResult(result)}\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style>\\r\\n  #formTile {\\r\\n    width: 100%;\\r\\n    height: 100%;\\r\\n    aspect-ratio: 1/1;\\r\\n    border-radius: 6px;\\r\\n    color: #2b2d2f;\\r\\n    display: grid;\\r\\n    place-items: center;\\r\\n    border: 3px #333333 solid;\\r\\n  }\\r\\n  .result {\\r\\n    margin-top: 0.14em;\\r\\n    font-size: 2vw;\\r\\n  }\\r\\n  \\r\\n  @media only screen and (max-width: 1100px) {\\r\\n    .result {\\r\\n      font-size: 3em;\\r\\n    }\\r\\n  }\\r\\n  @media only screen and (max-width: 600px) {\\r\\n    .result {\\r\\n      font-size: 7vw;\\r\\n      margin-top: 0.25em;\\r\\n    }\\r\\n  }\\r\\n</style>\\r\\n\"],\"names\":[],\"mappings\":\"AAsCE,SAAS,eAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,YAAY,CAAE,CAAC,CAAC,CAAC,CACjB,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,OAAO,CACd,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,GAAG,CAAC,OAAO,CAAC,KAAK,AAC3B,CAAC,AACD,OAAO,eAAC,CAAC,AACP,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,GAAG,AAChB,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,OAAO,eAAC,CAAC,AACP,SAAS,CAAE,GAAG,AAChB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,OAAO,eAAC,CAAC,AACP,SAAS,CAAE,GAAG,CACd,UAAU,CAAE,MAAM,AACpB,CAAC,AACH,CAAC\"}"
};
...
const FormTile = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let { result, starTeam } = $$props;
	if ($$props.result === void 0 && $$bindings.result && result !== void 0) $$bindings.result(result);
	if ($$props.starTeam === void 0 && $$bindings.starTeam && starTeam !== void 0) $$bindings.starTeam(starTeam);
	$$result.css.add(css$c);

	return `<div id="${"formTile"}" style="${"background: " + escape(background(result, starTeam), true)}" class="${"svelte-1doaosm"}"><div class="${"result svelte-1doaosm"}">${escape(formatResult(result))}</div>
</div>`;
});
...
const CurrentForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `<div class="${"current-form-row svelte-ngby83"}"><div class="${"icon pos-0 svelte-ngby83"}">${validate_component(FormTile, "FormTile").$$render(
			$$result,
			{
				result: formIcons[0],
				starTeam: formStarTeams[0]
			},
			{},
			{}
		)}</div>
    <div class="${"icon pos-1 svelte-ngby83"}">${validate_component(FormTile, "FormTile").$$render(
			$$result,
			{
				result: formIcons[1],
				starTeam: formStarTeams[1]
			},
			{},
			{}
		)}</div>
    <div class="${"icon pos-2 svelte-ngby83"}">${validate_component(FormTile, "FormTile").$$render(
			$$result,
			{
				result: formIcons[2],
				starTeam: formStarTeams[2]
			},
			{},
			{}
		)}</div>
    <div class="${"icon pos-3 svelte-ngby83"}">${validate_component(FormTile, "FormTile").$$render(
			$$result,
			{
				result: formIcons[3],
				starTeam: formStarTeams[3]
			},
			{},
			{}
		)}</div>
    <div class="${"icon pos4 svelte-ngby83"}">${validate_component(FormTile, "FormTile").$$render(
			$$result,
			{
				result: formIcons[4],
				starTeam: formStarTeams[4]
			},
			{},
			{}
		)}</div></div>
  <div class="${"current-form-row svelte-ngby83"}"><div class="${"icon-name pos-0 svelte-ngby83"}">${escape(formInitials[0])}</div>
    <div class="${"icon-name pos-1 svelte-ngby83"}">${escape(formInitials[1])}</div>
    <div class="${"icon-name pos-2 svelte-ngby83"}">${escape(formInitials[2])}</div>
    <div class="${"icon-name pos-3 svelte-ngby83"}">${escape(formInitials[3])}</div>
    <div class="${"icon-name pos-4 svelte-ngby83"}">${escape(formInitials[4])}</div></div>`
	: ``}
<div class="${"current-form svelte-ngby83"}">Current form:
...
const css$9 = {
	code: ".next-game-title.svelte-b5c3gb{width:max-content;padding:6px 20px;border-radius:0 0 var(--border-radius) 0}.next-game-season-complete.svelte-b5c3gb{display:grid;place-items:center;background:#f3f3f3;border:rgb(181, 181, 181) solid 5px;border-radius:var(--border-radius);height:98%}.next-game-title-text.svelte-b5c3gb{margin:0;color:rgb(181, 181, 181);display:flex}.next-game-logo.svelte-b5c3gb{height:225px;margin:10px;background-repeat:no-repeat;background-size:contain;background-position:center}.predictions-and-logo.svelte-b5c3gb{font-size:22px;width:45%;margin:auto}button.svelte-b5c3gb{background:none;color:inherit;border:none;padding:0;font:inherit;cursor:pointer;outline:inherit}.predictions-link.svelte-b5c3gb{text-decoration:none;color:#333}.predictions-link.svelte-b5c3gb:hover{color:rgb(120 120 120)}.past-results.svelte-b5c3gb{font-size:22px;width:55%;display:flex;flex-direction:column;margin:auto 0;margin-top:20px}.next-game-prediction.svelte-b5c3gb{border-radius:var(--border-radius);min-height:97.5%}.next-game-values.svelte-b5c3gb{display:flex;margin-right:5%;min-height:370px}.next-game-position.svelte-b5c3gb{font-size:3.5em;font-weight:700}.ordinal-position.svelte-b5c3gb{font-size:0.6em}.past-result.svelte-b5c3gb{font-size:16px;display:flex}.past-result-date.svelte-b5c3gb{font-size:13px;color:#333;margin:6px 0 1px}.prev-results-title.svelte-b5c3gb{font-weight:700;padding-top:0 !important;margin:0 !important}.no-prev-results.svelte-b5c3gb{background:grey;padding:60px 0 !important;display:grid;place-items:center;background:#f3f3f3;border:rgb(181, 181, 181) solid 5px;color:rgb(181, 181, 181);border-radius:var(--border-radius);margin:0 25px !important}.next-game-item.svelte-b5c3gb{border-radius:var(--border-radius)}.won.svelte-b5c3gb{background:rgb(169, 247, 169);background:#77dd77}.drew.svelte-b5c3gb{background:rgb(255, 207, 138);background:#ffb347}.lost.svelte-b5c3gb{background:#f77979;background:#c23b22}.accuracy.svelte-b5c3gb{margin-bottom:30px}.accuracy-item.svelte-b5c3gb{font-size:14px;color:rgb(120 120 120);margin-bottom:5px}.home-team.svelte-b5c3gb{float:left;text-align:left;border-radius:var(--border-radius) 0 0 var(--border-radius)}.score.svelte-b5c3gb{float:left;min-width:44px;margin:0 4px;text-align:center;font-weight:800;flex:3;margin-top:3px;align-self:center}.away-team.svelte-b5c3gb{float:left;text-align:right;border-radius:0 var(--border-radius) var(--border-radius) 0}.home-team.svelte-b5c3gb,.away-team.svelte-b5c3gb{font-size:16px;width:calc(50% - 18px);padding:5px 0 3px;flex:1;text-align:center}.next-game-team-btn.svelte-b5c3gb{color:inherit;text-align:left}@media only screen and (max-width: 1100px){.next-game-prediction.svelte-b5c3gb{margin:50px 20px 0}.next-game-values.svelte-b5c3gb{margin:5% 8% 5% 0}}@media only screen and (max-width: 800px){.next-game-prediction.svelte-b5c3gb{margin:50px 75px 0}.next-game-values.svelte-b5c3gb{flex-direction:column;margin:20px}.predictions-and-logo.svelte-b5c3gb{margin:0 auto;width:100%}.past-results.svelte-b5c3gb{margin:30px auto 0;width:100%}.next-game-prediction.svelte-b5c3gb{padding-bottom:0}.next-game-title-text.svelte-b5c3gb{flex-direction:column;text-align:left}.next-game-title.svelte-b5c3gb{padding:6px 15px}}@media only screen and (max-width: 700px){.next-game-prediction.svelte-b5c3gb{margin:40px 20px}}@media only screen and (max-width: 550px){.next-game-values.svelte-b5c3gb{margin:20px 10px;font-size:0.85em}.next-game-prediction.svelte-b5c3gb{margin:40px 15px}}",
	map: "{\"version\":3,\"file\":\"NextGame.svelte\",\"sources\":[\"NextGame.svelte\"],\"sourcesContent\":[\"<script lang=\\\"ts\\\">import SeasonComplete from \\\"./SeasonComplete.svelte\\\";\\r\\nfunction ordinal(n) {\\r\\n    let ord = [, \\\"st\\\", \\\"nd\\\", \\\"rd\\\"];\\r\\n    let a = n % 100;\\r\\n    return ord[a > 20 ? a % 10 : a] || \\\"th\\\";\\r\\n}\\r\\nfunction setOppTeam() {\\r\\n    if (data.upcoming[team].nextTeam != null) {\\r\\n        oppTeam = data.upcoming[team].nextTeam.toLowerCase().replace(/ /g, \\\"-\\\");\\r\\n    }\\r\\n}\\r\\nlet oppTeam;\\r\\n$: team && setOppTeam();\\r\\nexport let data, currentMatchday, team, showBadge, toAlias, toInitials, switchTeam;\\r\\n</script>\\r\\n\\r\\n{#if data != undefined}\\r\\n  {#if data.upcoming[team].nextTeam == null}\\r\\n    <SeasonComplete {data} />\\r\\n  {:else}\\r\\n    <div\\r\\n      class=\\\"next-game-prediction\\\"\\r\\n      style=\\\"border: 6px solid var(--{oppTeam});\\\"\\r\\n    >\\r\\n      <div class=\\\"next-game-title\\\" style=\\\"background-color: var(--{oppTeam});\\\">\\r\\n        <h1\\r\\n          class=\\\"next-game-title-text\\\"\\r\\n          style=\\\"color: var(--{oppTeam}-secondary);\\\"\\r\\n        >\\r\\n          Next Game:&nbsp\\r\\n          <button\\r\\n            on:click={() => {\\r\\n              switchTeam(\\r\\n                data.upcoming[team].nextTeam.toLowerCase().replace(/ /g, \\\"-\\\")\\r\\n              );\\r\\n            }}\\r\\n            class=\\\"next-game-team-btn\\\"\\r\\n            >{toAlias(data.upcoming[team].nextTeam)}&nbsp</button\\r\\n          >\\r\\n          ({data.upcoming[team].atHome ? \\\"Home\\\" : \\\"Away\\\"})\\r\\n        </h1>\\r\\n      </div>\\r\\n\\r\\n      <div class=\\\"next-game-values\\\">\\r\\n        <div class=\\\"predictions-and-logo\\\">\\r\\n          {#if showBadge}\\r\\n            <div\\r\\n              class=\\\"next-game-logo opposition-badge\\\"\\r\\n              style=\\\"background-image: url('{data.logoURLs[\\r\\n                data.upcoming[team].nextTeam\\r\\n              ]}')\\\"\\r\\n            />\\r\\n          {:else}\\r\\n            <div class=\\\"next-game-position\\\" />\\r\\n          {/if}\\r\\n          <div class=\\\"predictions\\\">\\r\\n            <div class=\\\"next-game-item\\\">\\r\\n              <div class=\\\"next-game-position\\\">\\r\\n                {data.standings[data.upcoming[team].nextTeam][data._id]\\r\\n                  .position}<span class=\\\"ordinal-position\\\"\\r\\n                  >{ordinal(\\r\\n                    data.standings[data.upcoming[team].nextTeam][data._id]\\r\\n                      .position\\r\\n                  )}</span\\r\\n                >\\r\\n              </div>\\r\\n            </div>\\r\\n            <div class=\\\"next-game-item\\\">\\r\\n              Current form:\\r\\n              {#if currentMatchday != null}\\r\\n                <b\\r\\n                  >{(\\r\\n                    data.form[data._id][data.upcoming[team].nextTeam][\\r\\n                      currentMatchday\\r\\n                    ].formRating5 * 100\\r\\n                  ).toFixed(1)}%</b\\r\\n                >\\r\\n              {:else}\\r\\n                None\\r\\n              {/if}\\r\\n            </div>\\r\\n            <div class=\\\"next-game-item\\\">\\r\\n              Score prediction\\r\\n              <br />\\r\\n              <a class=\\\"predictions-link\\\" href=\\\"/predictions\\\">\\r\\n                <b\\r\\n                  >{Math.round(data.upcoming[team].prediction.homeGoals)} - {Math.round(\\r\\n                    data.upcoming[team].prediction.awayGoals\\r\\n                  )}</b\\r\\n                >\\r\\n              </a>\\r\\n              <br />\\r\\n            </div>\\r\\n          </div>\\r\\n        </div>\\r\\n        <div class=\\\"past-results\\\">\\r\\n          {#if data.upcoming[team].prevMatches.length == 0}\\r\\n            <div class=\\\"next-game-item prev-results-title no-prev-results\\\">\\r\\n              No Previous Results\\r\\n            </div>\\r\\n          {:else}\\r\\n            <div class=\\\"next-game-item prev-results-title\\\">\\r\\n              Previous Results\\r\\n            </div>\\r\\n          {/if}\\r\\n\\r\\n          <!-- Display table of previous results against the next team this team is playing -->\\r\\n          {#each data.upcoming[team].prevMatches as prevMatch}\\r\\n            <div class=\\\"next-game-item-container\\\">\\r\\n              <div class=\\\"past-result-date\\\">\\r\\n                {new Date(prevMatch.date).toLocaleDateString(\\\"en-GB\\\", {\\r\\n                  weekday: \\\"short\\\",\\r\\n                  year: \\\"numeric\\\",\\r\\n                  month: \\\"short\\\",\\r\\n                  day: \\\"numeric\\\",\\r\\n                })}\\r\\n              </div>\\r\\n              <div class=\\\"next-game-item {prevMatch.result}\\\">\\r\\n                <div class=\\\"past-result\\\">\\r\\n                  <div\\r\\n                    class=\\\"home-team\\\"\\r\\n                    style=\\\"background: var(--{prevMatch.homeTeam\\r\\n                      .toLowerCase()\\r\\n                      .replace(/ /g, '-')}); color: var(--{prevMatch.homeTeam\\r\\n                      .toLowerCase()\\r\\n                      .replace(/ /g, '-')}-secondary)\\\"\\r\\n                  >\\r\\n                    {toInitials(prevMatch.homeTeam)}\\r\\n                  </div>\\r\\n                  <div class=\\\"score\\\">\\r\\n                    {prevMatch.homeGoals} - {prevMatch.awayGoals}\\r\\n                  </div>\\r\\n                  <div\\r\\n                    class=\\\"away-team\\\"\\r\\n                    style=\\\"background: var(--{prevMatch.awayTeam\\r\\n                      .toLowerCase()\\r\\n                      .replace(/ /g, '-')}); color: var(--{prevMatch.awayTeam\\r\\n                      .toLowerCase()\\r\\n                      .replace(/ /g, '-')}-secondary)\\\"\\r\\n                  >\\r\\n                    {toInitials(prevMatch.awayTeam)}\\r\\n                  </div>\\r\\n                </div>\\r\\n                <div style=\\\"clear: both\\\" />\\r\\n              </div>\\r\\n            </div>\\r\\n          {/each}\\r\\n        </div>\\r\\n      </div>\\r\\n    </div>\\r\\n  {/if}\\r\\n{/if}\\r\\n\\r\\n<style scoped>\\r\\n  .next-game-title {\\r\\n    width: max-content;\\r\\n    padding: 6px 20px;\\r\\n    border-radius: 0 0 var(--border-radius) 0;\\r\\n  }\\r\\n\\r\\n  .next-game-season-complete {\\r\\n    display: grid;\\r\\n    place-items: center;\\r\\n    background: #f3f3f3;\\r\\n    border: rgb(181, 181, 181) solid 5px;\\r\\n    border-radius: var(--border-radius);\\r\\n    height: 98%;\\r\\n  }\\r\\n\\r\\n  .next-game-title-text {\\r\\n    margin: 0;\\r\\n    color: rgb(181, 181, 181);\\r\\n    display: flex;\\r\\n  }\\r\\n\\r\\n  .next-game-logo {\\r\\n    height: 225px;\\r\\n    margin: 10px;\\r\\n    background-repeat: no-repeat;\\r\\n    background-size: contain;\\r\\n    background-position: center;\\r\\n  }\\r\\n\\r\\n  .predictions-and-logo {\\r\\n    font-size: 22px;\\r\\n    width: 45%;\\r\\n    margin: auto;\\r\\n  }\\r\\n\\r\\n  button {\\r\\n    background: none;\\r\\n    color: inherit;\\r\\n    border: none;\\r\\n    padding: 0;\\r\\n    font: inherit;\\r\\n    cursor: pointer;\\r\\n    outline: inherit;\\r\\n  }\\r\\n\\r\\n  .predictions-link {\\r\\n    text-decoration: none;\\r\\n    color: #333;\\r\\n  }\\r\\n\\r\\n  .predictions-link:hover {\\r\\n    color: rgb(120 120 120);\\r\\n  }\\r\\n\\r\\n  .past-results {\\r\\n    font-size: 22px;\\r\\n    width: 55%;\\r\\n    display: flex;\\r\\n    flex-direction: column;\\r\\n    margin: auto 0;\\r\\n    margin-top: 20px;\\r\\n  }\\r\\n\\r\\n  .next-game-prediction {\\r\\n    border-radius: var(--border-radius);\\r\\n    min-height: 97.5%;\\r\\n  }\\r\\n\\r\\n  .next-game-values {\\r\\n    display: flex;\\r\\n    margin-right: 5%;\\r\\n    min-height: 370px;\\r\\n  }\\r\\n\\r\\n  .next-game-position {\\r\\n    font-size: 3.5em;\\r\\n    font-weight: 700;\\r\\n  }\\r\\n  .ordinal-position {\\r\\n    font-size: 0.6em;\\r\\n  }\\r\\n\\r\\n  .past-result {\\r\\n    font-size: 16px;\\r\\n    display: flex;\\r\\n  }\\r\\n\\r\\n  .past-result-date {\\r\\n    font-size: 13px;\\r\\n    color: #333;\\r\\n    margin: 6px 0 1px;\\r\\n  }\\r\\n\\r\\n  .prev-results-title {\\r\\n    font-weight: 700;\\r\\n    padding-top: 0 !important;\\r\\n    margin: 0 !important;\\r\\n  }\\r\\n  .no-prev-results {\\r\\n    background: grey;\\r\\n    padding: 60px 0 !important;\\r\\n    display: grid;\\r\\n    place-items: center;\\r\\n    background: #f3f3f3;\\r\\n    border: rgb(181, 181, 181) solid 5px;\\r\\n    color: rgb(181, 181, 181);\\r\\n    border-radius: var(--border-radius);\\r\\n    margin: 0 25px !important;\\r\\n  }\\r\\n  .next-game-item {\\r\\n    border-radius: var(--border-radius);\\r\\n  }\\r\\n\\r\\n  .won {\\r\\n    background: rgb(169, 247, 169);\\r\\n    background: #77dd77;\\r\\n  }\\r\\n  .drew {\\r\\n    background: rgb(255, 207, 138);\\r\\n    background: #ffb347;\\r\\n  }\\r\\n  .lost {\\r\\n    background: #f77979;\\r\\n    background: #c23b22;\\r\\n  }\\r\\n\\r\\n  .accuracy {\\r\\n    margin-bottom: 30px;\\r\\n  }\\r\\n\\r\\n  .accuracy-item {\\r\\n    font-size: 14px;\\r\\n    color: rgb(120 120 120);\\r\\n    margin-bottom: 5px;\\r\\n  }\\r\\n\\r\\n  .home-team {\\r\\n    float: left;\\r\\n    text-align: left;\\r\\n    border-radius: var(--border-radius) 0 0 var(--border-radius);\\r\\n  }\\r\\n\\r\\n  .score {\\r\\n    float: left;\\r\\n    min-width: 44px;\\r\\n    margin: 0 4px;\\r\\n    text-align: center;\\r\\n    font-weight: 800;\\r\\n    flex: 3;\\r\\n    margin-top: 3px;\\r\\n\\r\\n    align-self: center;\\r\\n  }\\r\\n\\r\\n  .away-team {\\r\\n    float: left;\\r\\n    text-align: right;\\r\\n    border-radius: 0 var(--border-radius) var(--border-radius) 0;\\r\\n  }\\r\\n\\r\\n  .home-team,\\r\\n  .away-team {\\r\\n    font-size: 16px;\\r\\n    width: calc(50% - 18px);\\r\\n    padding: 5px 0 3px;\\r\\n    flex: 1;\\r\\n    text-align: center;\\r\\n  }\\r\\n\\r\\n  .next-game-team-btn {\\r\\n    color: inherit;\\r\\n    text-align: left;\\r\\n  }\\r\\n\\r\\n  @media only screen and (max-width: 1100px) {\\r\\n    .next-game-prediction {\\r\\n      margin: 50px 20px 0;\\r\\n    }\\r\\n    .next-game-values {\\r\\n      margin: 5% 8% 5% 0;\\r\\n    }\\r\\n  }\\r\\n\\r\\n  @media only screen and (max-width: 800px) {\\r\\n    .next-game-prediction {\\r\\n      margin: 50px 75px 0;\\r\\n    }\\r\\n\\r\\n    /* Change next game to column orientation */\\r\\n    .next-game-values {\\r\\n      flex-direction: column;\\r\\n      margin: 20px;\\r\\n    }\\r\\n\\r\\n    .predictions-and-logo {\\r\\n      margin: 0 auto;\\r\\n      width: 100%;\\r\\n    }\\r\\n\\r\\n    .past-results {\\r\\n      margin: 30px auto 0;\\r\\n      width: 100%;\\r\\n    }\\r\\n\\r\\n    .next-game-prediction {\\r\\n      padding-bottom: 0;\\r\\n    }\\r\\n    .next-game-title-text {\\r\\n      flex-direction: column;\\r\\n      text-align: left;\\r\\n    }\\r\\n\\r\\n    .next-game-title {\\r\\n      padding: 6px 15px;\\r\\n    }\\r\\n  }\\r\\n  @media only screen and (max-width: 700px) {\\r\\n    .next-game-prediction {\\r\\n      margin: 40px 20px;\\r\\n    }\\r\\n  }\\r\\n  @media only screen and (max-width: 550px) {\\r\\n    .next-game-values {\\r\\n      margin: 20px 10px;\\r\\n      font-size: 0.85em;\\r\\n    }\\r\\n    .next-game-prediction {\\r\\n      margin: 40px 15px;\\r\\n    }\\r\\n  }\\r\\n</style>\\r\\n\"],\"names\":[],\"mappings\":\"AA0JE,gBAAgB,cAAC,CAAC,AAChB,KAAK,CAAE,WAAW,CAClB,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,aAAa,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,CAAC,CAAC,AAC3C,CAAC,AAED,0BAA0B,cAAC,CAAC,AAC1B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,GAAG,CACpC,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,MAAM,CAAE,GAAG,AACb,CAAC,AAED,qBAAqB,cAAC,CAAC,AACrB,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACzB,OAAO,CAAE,IAAI,AACf,CAAC,AAED,eAAe,cAAC,CAAC,AACf,MAAM,CAAE,KAAK,CACb,MAAM,CAAE,IAAI,CACZ,iBAAiB,CAAE,SAAS,CAC5B,eAAe,CAAE,OAAO,CACxB,mBAAmB,CAAE,MAAM,AAC7B,CAAC,AAED,qBAAqB,cAAC,CAAC,AACrB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,IAAI,AACd,CAAC,AAED,MAAM,cAAC,CAAC,AACN,UAAU,CAAE,IAAI,CAChB,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,CAAC,CACV,IAAI,CAAE,OAAO,CACb,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,OAAO,AAClB,CAAC,AAED,iBAAiB,cAAC,CAAC,AACjB,eAAe,CAAE,IAAI,CACrB,KAAK,CAAE,IAAI,AACb,CAAC,AAED,+BAAiB,MAAM,AAAC,CAAC,AACvB,KAAK,CAAE,IAAI,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,AACzB,CAAC,AAED,aAAa,cAAC,CAAC,AACb,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,GAAG,CACV,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,IAAI,CAAC,CAAC,CACd,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,qBAAqB,cAAC,CAAC,AACrB,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,iBAAiB,cAAC,CAAC,AACjB,OAAO,CAAE,IAAI,CACb,YAAY,CAAE,EAAE,CAChB,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,mBAAmB,cAAC,CAAC,AACnB,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,GAAG,AAClB,CAAC,AACD,iBAAiB,cAAC,CAAC,AACjB,SAAS,CAAE,KAAK,AAClB,CAAC,AAED,YAAY,cAAC,CAAC,AACZ,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,IAAI,AACf,CAAC,AAED,iBAAiB,cAAC,CAAC,AACjB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CAAC,CAAC,CAAC,GAAG,AACnB,CAAC,AAED,mBAAmB,cAAC,CAAC,AACnB,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,CAAC,CAAC,UAAU,CACzB,MAAM,CAAE,CAAC,CAAC,UAAU,AACtB,CAAC,AACD,gBAAgB,cAAC,CAAC,AAChB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,CAAC,CAAC,CAAC,UAAU,CAC1B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,GAAG,CACpC,KAAK,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACzB,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,MAAM,CAAE,CAAC,CAAC,IAAI,CAAC,UAAU,AAC3B,CAAC,AACD,eAAe,cAAC,CAAC,AACf,aAAa,CAAE,IAAI,eAAe,CAAC,AACrC,CAAC,AAED,IAAI,cAAC,CAAC,AACJ,UAAU,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAC9B,UAAU,CAAE,OAAO,AACrB,CAAC,AACD,KAAK,cAAC,CAAC,AACL,UAAU,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAC9B,UAAU,CAAE,OAAO,AACrB,CAAC,AACD,KAAK,cAAC,CAAC,AACL,UAAU,CAAE,OAAO,CACnB,UAAU,CAAE,OAAO,AACrB,CAAC,AAED,SAAS,cAAC,CAAC,AACT,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,cAAc,cAAC,CAAC,AACd,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,CACvB,aAAa,CAAE,GAAG,AACpB,CAAC,AAED,UAAU,cAAC,CAAC,AACV,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,AAC9D,CAAC,AAED,MAAM,cAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,CAAC,CAAC,GAAG,CACb,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,GAAG,CAChB,IAAI,CAAE,CAAC,CACP,UAAU,CAAE,GAAG,CAEf,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,UAAU,cAAC,CAAC,AACV,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,KAAK,CACjB,aAAa,CAAE,CAAC,CAAC,IAAI,eAAe,CAAC,CAAC,IAAI,eAAe,CAAC,CAAC,CAAC,AAC9D,CAAC,AAED,wBAAU,CACV,UAAU,cAAC,CAAC,AACV,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CACvB,OAAO,CAAE,GAAG,CAAC,CAAC,CAAC,GAAG,CAClB,IAAI,CAAE,CAAC,CACP,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,mBAAmB,cAAC,CAAC,AACnB,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,qBAAqB,cAAC,CAAC,AACrB,MAAM,CAAE,IAAI,CAAC,IAAI,CAAC,CAAC,AACrB,CAAC,AACD,iBAAiB,cAAC,CAAC,AACjB,MAAM,CAAE,EAAE,CAAC,EAAE,CAAC,EAAE,CAAC,CAAC,AACpB,CAAC,AACH,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,qBAAqB,cAAC,CAAC,AACrB,MAAM,CAAE,IAAI,CAAC,IAAI,CAAC,CAAC,AACrB,CAAC,AAGD,iBAAiB,cAAC,CAAC,AACjB,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,qBAAqB,cAAC,CAAC,AACrB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,KAAK,CAAE,IAAI,AACb,CAAC,AAED,aAAa,cAAC,CAAC,AACb,MAAM,CAAE,IAAI,CAAC,IAAI,CAAC,CAAC,CACnB,KAAK,CAAE,IAAI,AACb,CAAC,AAED,qBAAqB,cAAC,CAAC,AACrB,cAAc,CAAE,CAAC,AACnB,CAAC,AACD,qBAAqB,cAAC,CAAC,AACrB,cAAc,CAAE,MAAM,CACtB,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,gBAAgB,cAAC,CAAC,AAChB,OAAO,CAAE,GAAG,CAAC,IAAI,AACnB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,qBAAqB,cAAC,CAAC,AACrB,MAAM,CAAE,IAAI,CAAC,IAAI,AACnB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,iBAAiB,cAAC,CAAC,AACjB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,SAAS,CAAE,MAAM,AACnB,CAAC,AACD,qBAAqB,cAAC,CAAC,AACrB,MAAM,CAAE,IAAI,CAAC,IAAI,AACnB,CAAC,AACH,CAAC\"}"
};
...
const NextGame = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `${data.upcoming[team].nextTeam == null
		...
		: `<div class="${"next-game-prediction svelte-b5c3gb"}" style="${"border: 6px solid var(--" + escape(oppTeam, true) + ");"}"><div class="${"next-game-title svelte-b5c3gb"}" style="${"background-color: var(--" + escape(oppTeam, true) + ");"}"><h1 class="${"next-game-title-text svelte-b5c3gb"}" style="${"color: var(--" + escape(oppTeam, true) + "-secondary);"}">Next Game: 
          <button class="${"next-game-team-btn svelte-b5c3gb"}">${escape(toAlias(data.upcoming[team].nextTeam))} </button>
          (${escape(data.upcoming[team].atHome ? "Home" : "Away")})
        </h1></div>

      <div class="${"next-game-values svelte-b5c3gb"}"><div class="${"predictions-and-logo svelte-b5c3gb"}">${showBadge
			? `<div class="${"next-game-logo opposition-badge svelte-b5c3gb"}" style="${"background-image: url('" + escape(data.logoURLs[data.upcoming[team].nextTeam], true) + "')"}"></div>`
			: `<div class="${"next-game-position svelte-b5c3gb"}"></div>`}
          <div class="${"predictions"}"><div class="${"next-game-item svelte-b5c3gb"}"><div class="${"next-game-position svelte-b5c3gb"}">${escape(data.standings[data.upcoming[team].nextTeam][data._id].position)}<span class="${"ordinal-position svelte-b5c3gb"}">${escape(ordinal$1(data.standings[data.upcoming[team].nextTeam][data._id].position))}</span></div></div>
            <div class="${"next-game-item svelte-b5c3gb"}">Current form:
              ${currentMatchday != null
			? `<b>${escape((data.form[data._id][data.upcoming[team].nextTeam][currentMatchday].formRating5 * 100).toFixed(1))}%</b>`
			: `None`}</div>
            <div class="${"next-game-item svelte-b5c3gb"}">Score prediction
              <br>
              <a class="${"predictions-link svelte-b5c3gb"}" href="${"/predictions"}"><b>${escape(Math.round(data.upcoming[team].prediction.homeGoals))} - ${escape(Math.round(data.upcoming[team].prediction.awayGoals))}</b></a>
              <br></div></div></div>
        <div class="${"past-results svelte-b5c3gb"}">${data.upcoming[team].prevMatches.length == 0
			? `<div class="${"next-game-item prev-results-title no-prev-results svelte-b5c3gb"}">No Previous Results
            </div>`
			: `<div class="${"next-game-item prev-results-title svelte-b5c3gb"}">Previous Results
            </div>`}

          
          ${each(data.upcoming[team].prevMatches, prevMatch => {
				return `<div class="${"next-game-item-container"}"><div class="${"past-result-date svelte-b5c3gb"}">${escape(new Date(prevMatch.date).toLocaleDateString("en-GB", {
					weekday: "short",
					year: "numeric",
					month: "short",
					day: "numeric"
				}))}</div>
              <div class="${"next-game-item " + escape(prevMatch.result, true) + " svelte-b5c3gb"}"><div class="${"past-result svelte-b5c3gb"}"><div class="${"home-team svelte-b5c3gb"}" style="${"background: var(--" + escape(prevMatch.homeTeam.toLowerCase().replace(/ /g, '-'), true) + "); color: var(--" + escape(prevMatch.homeTeam.toLowerCase().replace(/ /g, '-'), true) + "-secondary)"}">${escape(toInitials(prevMatch.homeTeam))}</div>
                  <div class="${"score svelte-b5c3gb"}">${escape(prevMatch.homeGoals)} - ${escape(prevMatch.awayGoals)}</div>
                  <div class="${"away-team svelte-b5c3gb"}" style="${"background: var(--" + escape(prevMatch.awayTeam.toLowerCase().replace(/ /g, '-'), true) + "); color: var(--" + escape(prevMatch.awayTeam.toLowerCase().replace(/ /g, '-'), true) + "-secondary)"}">${escape(toInitials(prevMatch.awayTeam))}
                  </div></div>
...
const StatsValues = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `<div class="${"season-stats svelte-jyia24"}"><div class="${"season-stat goals-per-game svelte-jyia24"}"><div class="${"season-stat-value svelte-jyia24"}">${escape(stats[team].xG.toFixed(2))}
    ...
    <div class="${"season-stat conceded-per-game svelte-jyia24"}"><div class="${"season-stat-value svelte-jyia24"}">${escape(stats[team].xC.toFixed(2))}
    ...
    <div class="${"season-stat clean-sheet-ratio svelte-jyia24"}"><div class="${"season-stat-value svelte-jyia24"}">${escape(stats[team].cleanSheetRatio.toFixed(2))}
...
${validate_component(Router, "Router").$$render($$result, {}, {}, {
		default: () => {
			return `<div id="${"team"}" class="${"svelte-yzrut0"}">${validate_component(Nav, "Nav").$$render(
				$$result,
				{
					team: hyphenatedTeam,
					teams,
    ...
    <button id="${"mobileNavBtn"}" class="${"svelte-yzrut0"}">Select Team </button>

    <div id="${"dashboard"}" class="${"svelte-yzrut0"}"><div class="${"header svelte-yzrut0"}" style="${"background-color: var(--" + escape(hyphenatedTeam, true) + ");"}"><a class="${"main-link no-decoration svelte-yzrut0"}" href="${"/" + escape(hyphenatedTeam, true)}"><div class="${"title svelte-yzrut0"}" style="${"color: var(--" + escape(hyphenatedTeam + '-secondary', true) + ");"}">${escape(toAlias(team))}</div></a></div>

      ${data != undefined
			? `<div class="${"page-content svelte-yzrut0"}"><div class="${"row multi-element-row small-bottom-margin svelte-yzrut0"}">${`<div class="${"row-left position-no-badge svelte-yzrut0"}"><div class="${"circles-background-container svelte-yzrut0"}"><svg class="${"circles-background svelte-yzrut0"}"><circle cx="${"300"}" cy="${"150"}" r="${"100"}" stroke-width="${"0"}" fill="${"var(--" + escape(hyphenatedTeam, true) + "-secondary)"}"></circle><circle cx="${"170"}" cy="${"170"}" r="${"140"}" stroke-width="${"0"}" fill="${"var(--" + escape(hyphenatedTeam, true) + ")"}"></circle><circle cx="${"300"}" cy="${"320"}" r="${"170"}" stroke-width="${"0"}" fill="${"var(--" + escape(hyphenatedTeam, true) + ")"}"></circle></svg></div>
                <div class="${"position-central svelte-yzrut0"}">${escape(data.standings[team][data._id].position)}</div></div>`}
            <div class="${"row-right fixtures-graph row-graph svelte-yzrut0"}"><h1 class="${"lowered"}">Fixtures</h1>
          ...
          <div class="${"row multi-element-row svelte-yzrut0"}"><div class="${"row-left form-details svelte-yzrut0"}">${validate_component(CurrentForm, "CurrentForm").$$render($$result, { data, currentMatchday, team, toInitials }, {}, {})}
            ...
            <div class="${"row-right svelte-yzrut0"}">${validate_component(NextGame, "NextGame").$$render(
					$$result,
					{
						data,
						currentMatchday,
          ...
          <div class="${"row svelte-yzrut0"}"><div class="${"form-graph row-graph svelte-yzrut0"}"><h1 class="${"lowered"}">Form Over Time</h1>
          ...
          <div class="${"row svelte-yzrut0"}"><div class="${"position-over-time-graph row-graph svelte-yzrut0"}"><h1 class="${"lowered"}">Position Over Time</h1>
          ...
          <div class="${"row no-bottom-margin svelte-yzrut0"}"><div class="${"goals-scored-vs-conceded-graph row-graph svelte-yzrut0"}"><h1 class="${"lowered"}">Goals Scored and Conceded</h1>
          ...
          <div class="${"row svelte-yzrut0"}"><div class="${"row-graph svelte-yzrut0"}"><div class="${"clean-sheets graph full-row-graph svelte-yzrut0"}">${validate_component(CleanSheetsGraph, "CleanSheetsGraph").$$render($$result, { data, team, playedMatchdays, mobileView }, {}, {})}</div></div></div>

          <div class="${"season-stats-row svelte-yzrut0"}">${validate_component(StatsValues, "StatsValues").$$render($$result, { data, team }, {}, {})}</div>

          <div class="${"row svelte-yzrut0"}"><div class="${"goals-freq-row row-graph svelte-yzrut0"}"><h1>Goals Per Game</h1>
              ${validate_component(GoalsPerGame, "GoalsPerGame").$$render($$result, { data, team, mobileView }, {}, {})}</div></div>

          <div class="${"row svelte-yzrut0"}"><div class="${"row-graph svelte-yzrut0"}"><div class="${"score-freq graph svelte-yzrut0"}">${validate_component(ScorelineFreqGraph, "ScorelineFreqGraph").$$render($$result, { data, team, mobileView }, {}, {})}</div></div></div>
          
          <div class="${"row svelte-yzrut0"}"><div class="${"spider-chart-row row-graph svelte-yzrut0"}"><h1>Team Comparison</h1>
              <div class="${"spider-chart-container svelte-yzrut0"}">${validate_component(SpiderGraph, "SpiderGraph").$$render($$result, { data, team, teams, toAlias, toName }, {}, {})}</div></div></div>
...
const css$1 = {
	code: "#home.svelte-11buupz{background:black;min-height:100vh;display:grid;place-items:center}.content.svelte-11buupz{display:grid;place-items:center;margin-bottom:100px}img.svelte-11buupz{width:min(80%, 1000px)}.links.svelte-11buupz{display:flex;margin-top:20px}.fantasy-link.svelte-11buupz{color:#37003d;background:linear-gradient(70deg, #00ff87, #02efff, #5e80ff);padding:18px 0}.dashboard-link.svelte-11buupz{color:#37003d;background:#00ff87;padding:18px 0}.dashboard-link.svelte-11buupz,.fantasy-link.svelte-11buupz{font-size:1.2em;border-radius:5px;font-weight:bold;letter-spacing:0.02em;margin:0 20px;width:160px;display:grid;place-items:center;box-shadow:0 0 30px 1px #00ff8825, \r\n      0 0 60px 2px #02eeff23}@media only screen and (max-width: 800px){img.svelte-11buupz{width:90%}.dashboard-link.svelte-11buupz{padding:20px 38.45px}.dashboard-link.svelte-11buupz,.fantasy-link.svelte-11buupz{font-size:1.2em}.links.svelte-11buupz{flex-direction:column}}@media only screen and (max-width: 500px){.fantasy-link.svelte-11buupz{padding:20px 66.7px}.dashboard-link.svelte-11buupz,.fantasy-link.svelte-11buupz{font-size:1em}}",
	map: "{\"version\":3,\"file\":\"Home.svelte\",\"sources\":[\"Home.svelte\"],\"sourcesContent\":[\"<script lang=\\\"ts\\\">import { Router } from \\\"svelte-routing\\\";\\r\\n</script>\\r\\n\\r\\n<svelte:head>\\r\\n  <title>Premier League</title>\\r\\n  <meta name=\\\"description\\\" content=\\\"Premier League Statistics Dashboard\\\" />\\r\\n</svelte:head>\\r\\n\\r\\n<Router>\\r\\n  <div id=\\\"home\\\">\\r\\n    <div class=\\\"content\\\">\\r\\n      <img src=\\\"img/pldashboard4.png\\\" alt=\\\"pldashboard\\\" />\\r\\n      <div class=\\\"links\\\">\\r\\n        <a class=\\\"dashboard-link\\\" href=\\\"/\\\">Dashboard</a>\\r\\n        <a class=\\\"fantasy-link\\\" href=\\\"/\\\">Fantasy</a>\\r\\n      </div>\\r\\n    </div>\\r\\n  </div>\\r\\n</Router>\\r\\n\\r\\n<style scoped>\\r\\n  #home {\\r\\n    background: black;\\r\\n    min-height: 100vh;\\r\\n    display: grid;\\r\\n    place-items: center;\\r\\n  }\\r\\n  .content {\\r\\n    display: grid;\\r\\n    place-items: center;\\r\\n    margin-bottom: 100px;\\r\\n  }\\r\\n  img {\\r\\n    width: min(80%, 1000px);\\r\\n  }\\r\\n  .links {\\r\\n    display: flex;\\r\\n    margin-top: 20px;\\r\\n  }\\r\\n  .fantasy-link {\\r\\n    color: #37003d;\\r\\n    background: linear-gradient(70deg, #00ff87, #02efff, #5e80ff);\\r\\n    padding: 18px 0;\\r\\n  }\\r\\n  .dashboard-link {\\r\\n    color: #37003d;\\r\\n    background: #00ff87;\\r\\n    padding: 18px 0;\\r\\n  }\\r\\n  .dashboard-link,\\r\\n  .fantasy-link {\\r\\n    font-size: 1.2em;\\r\\n    border-radius: 5px;\\r\\n    font-weight: bold;\\r\\n    letter-spacing: 0.02em;\\r\\n    margin: 0 20px;\\r\\n    width: 160px;\\r\\n    display: grid;\\r\\n    place-items: center;\\r\\n    box-shadow: \\r\\n      0 0 30px 1px #00ff8825, \\r\\n      0 0 60px 2px #02eeff23;\\r\\n  }\\r\\n\\r\\n  @media only screen and (max-width: 800px) {\\r\\n    img {\\r\\n      width: 90%;\\r\\n    }\\r\\n    .dashboard-link {\\r\\n      padding: 20px 38.45px;\\r\\n    }\\r\\n    .dashboard-link,\\r\\n    .fantasy-link {\\r\\n      font-size: 1.2em;\\r\\n    }\\r\\n    .links {\\r\\n      flex-direction: column;\\r\\n    }\\r\\n  }\\r\\n  @media only screen and (max-width: 500px) {\\r\\n    .fantasy-link {\\r\\n      padding: 20px 66.7px;\\r\\n    }\\r\\n    .dashboard-link,\\r\\n    .fantasy-link {\\r\\n      font-size: 1em;\\r\\n    }\\r\\n  }\\r\\n</style>\\r\\n\"],\"names\":[],\"mappings\":\"AAqBE,KAAK,eAAC,CAAC,AACL,UAAU,CAAE,KAAK,CACjB,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AACD,QAAQ,eAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,KAAK,AACtB,CAAC,AACD,GAAG,eAAC,CAAC,AACH,KAAK,CAAE,IAAI,GAAG,CAAC,CAAC,MAAM,CAAC,AACzB,CAAC,AACD,MAAM,eAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,IAAI,AAClB,CAAC,AACD,aAAa,eAAC,CAAC,AACb,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,gBAAgB,KAAK,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CAC7D,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AACD,eAAe,eAAC,CAAC,AACf,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,OAAO,CACnB,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AACD,8BAAe,CACf,aAAa,eAAC,CAAC,AACb,SAAS,CAAE,KAAK,CAChB,aAAa,CAAE,GAAG,CAClB,WAAW,CAAE,IAAI,CACjB,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,UAAU,CACR,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,GAAG,CAAC,SAAS,CAAC;MACvB,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,GAAG,CAAC,SAAS,AAC1B,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,GAAG,eAAC,CAAC,AACH,KAAK,CAAE,GAAG,AACZ,CAAC,AACD,eAAe,eAAC,CAAC,AACf,OAAO,CAAE,IAAI,CAAC,OAAO,AACvB,CAAC,AACD,8BAAe,CACf,aAAa,eAAC,CAAC,AACb,SAAS,CAAE,KAAK,AAClB,CAAC,AACD,MAAM,eAAC,CAAC,AACN,cAAc,CAAE,MAAM,AACxB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,aAAa,eAAC,CAAC,AACb,OAAO,CAAE,IAAI,CAAC,MAAM,AACtB,CAAC,AACD,8BAAe,CACf,aAAa,eAAC,CAAC,AACb,SAAS,CAAE,GAAG,AAChB,CAAC,AACH,CAAC\"}"
};
...
${validate_component(Router, "Router").$$render($$result, {}, {}, {
		default: () => {
			return `<div id="${"home"}" class="${"svelte-11buupz"}"><div class="${"content svelte-11buupz"}"><img src="${"img/pldashboard4.png"}" alt="${"pldashboard"}" class="${"svelte-11buupz"}">
      <div class="${"links svelte-11buupz"}"><a class="${"dashboard-link svelte-11buupz"}" href="${"/"}">Dashboard</a>
        <a class="${"fantasy-link svelte-11buupz"}" href="${"/"}">Fantasy</a></div></div></div>`;
		}
	})}`;
});

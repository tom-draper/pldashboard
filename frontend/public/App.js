...
const css$a = {
	code: ".current-form.svelte-lslqot{font-size:1.8rem;margin:20px 10px}.current-form-row.svelte-lslqot{font-size:0.9em;display:flex;width:min(100%, 500px)}.icon.svelte-lslqot{position:relative;width:20%;height:0;padding-bottom:20%;margin:0 5px;background-repeat:no-repeat;background-size:contain}.icon-name.svelte-lslqot{position:relative;width:20%;margin:0 5px}.pos-4.svelte-lslqot{opacity:100%}.pos-3.svelte-lslqot{opacity:90%}.pos-2.svelte-lslqot{opacity:80%}.pos-1.svelte-lslqot{opacity:70%}.pos-0.svelte-lslqot{opacity:50%}",
...
const CurrentForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `<div class="${"current-form-row svelte-lslqot"}"><div class="${"icon pos-0 " + escape(formIcons[0], true) + " " + escape(formStarTeams[0], true) + " svelte-lslqot"}"></div>
    <div class="${"icon pos-1 " + escape(formIcons[1], true) + " " + escape(formStarTeams[1], true) + " svelte-lslqot"}"></div>
    <div class="${"icon pos-2 " + escape(formIcons[2], true) + " " + escape(formStarTeams[2], true) + " svelte-lslqot"}"></div>
    <div class="${"icon pos-3 " + escape(formIcons[3], true) + " " + escape(formStarTeams[3], true) + " svelte-lslqot"}"></div>
    <div class="${"icon pos-4 " + escape(formIcons[4], true) + " " + escape(formStarTeams[4], true) + " svelte-lslqot"}"></div></div>
  <div class="${"current-form-row svelte-lslqot"}"><div class="${"icon-name pos-0 svelte-lslqot"}">${escape(formInitials[0])}</div>
    <div class="${"icon-name pos-1 svelte-lslqot"}">${escape(formInitials[1])}</div>
    <div class="${"icon-name pos-2 svelte-lslqot"}">${escape(formInitials[2])}</div>
    <div class="${"icon-name pos-3 svelte-lslqot"}">${escape(formInitials[3])}</div>
    <div class="${"icon-name pos-4 svelte-lslqot"}">${escape(formInitials[4])}</div></div>`
	: ``}
<div class="${"current-form svelte-lslqot"}">Current form:
...
const css$8 = {
	code: ".next-game-title.svelte-1ps5l7l{width:max-content;padding:6px 20px;border-radius:0 0 var(--border-radius) 0}.next-game-season-complete.svelte-1ps5l7l{display:grid;place-items:center;background:#f3f3f3;border:rgb(181, 181, 181) solid 5px;border-radius:var(--border-radius);height:98%}.next-game-title-text.svelte-1ps5l7l{margin:0;color:rgb(181, 181, 181);display:flex}.next-game-logo.svelte-1ps5l7l{height:225px;margin:10px;background-repeat:no-repeat;background-size:contain;background-position:center}.predictions-and-logo.svelte-1ps5l7l{font-size:22px;width:45%;margin:auto}button.svelte-1ps5l7l{background:none;color:inherit;border:none;padding:0;font:inherit;cursor:pointer;outline:inherit}.predictions-link.svelte-1ps5l7l{text-decoration:none;color:#333}.predictions-link.svelte-1ps5l7l:hover{color:rgb(120 120 120)}.past-results.svelte-1ps5l7l{font-size:22px;width:55%;display:flex;flex-direction:column;margin:auto 0}.next-game-prediction.svelte-1ps5l7l{border-radius:var(--border-radius);min-height:97.5%}.next-game-values.svelte-1ps5l7l{display:flex;margin-right:5%;min-height:370px}.next-game-position.svelte-1ps5l7l{font-size:3.5em;font-weight:700}.ordinal-position.svelte-1ps5l7l{font-size:0.6em}.past-result.svelte-1ps5l7l{font-size:17px;display:flex;margin:0 5% 2px}.drew.svelte-1ps5l7l{background-color:rgb(255, 207, 139)}.won.svelte-1ps5l7l{background-color:rgb(169, 247, 169)}.lost.svelte-1ps5l7l{background-color:#f77979}.past-result-date.svelte-1ps5l7l{font-size:13px;color:#333}.prev-results-title.svelte-1ps5l7l{font-weight:700;padding-top:0 !important;margin:0 !important}.no-prev-results.svelte-1ps5l7l{background:grey;padding:60px 0 !important;display:grid;place-items:center;background:#f3f3f3;border:rgb(181, 181, 181) solid 5px;color:rgb(181, 181, 181);border-radius:var(--border-radius);margin:0 25px !important}.next-game-item.svelte-1ps5l7l{padding:7px 0 4px;border-radius:var(--border-radius);margin-top:4px}.accuracy.svelte-1ps5l7l{margin-bottom:30px}.accuracy-item.svelte-1ps5l7l{font-size:14px;color:rgb(120 120 120);margin-bottom:5px}.home-team.svelte-1ps5l7l{float:left;width:calc(50% - 18px);text-align:left}.score.svelte-1ps5l7l{float:left;min-width:44px;margin:0 4px;text-align:center;font-weight:800}.away-team.svelte-1ps5l7l{float:left;width:calc(50% - 18px);text-align:right}.home-team.svelte-1ps5l7l,.away-team.svelte-1ps5l7l{font-size:16px}.next-game-team-btn.svelte-1ps5l7l{color:inherit;text-align:left}@media only screen and (max-width: 1100px){.next-game-prediction.svelte-1ps5l7l{margin:50px 20px 0}.next-game-values.svelte-1ps5l7l{margin:5% 8% 5% 0}}@media only screen and (max-width: 800px){.next-game-prediction.svelte-1ps5l7l{margin:50px 75px 0}.next-game-values.svelte-1ps5l7l{flex-direction:column;margin:20px}.predictions-and-logo.svelte-1ps5l7l{margin:0 auto;width:100%}.past-results.svelte-1ps5l7l{margin:30px auto 0;width:100%}.next-game-prediction.svelte-1ps5l7l{padding-bottom:0}.next-game-title-text.svelte-1ps5l7l{flex-direction:column;text-align:left}.next-game-title.svelte-1ps5l7l{padding:6px 15px}}@media only screen and (max-width: 700px){.next-game-prediction.svelte-1ps5l7l{margin:40px 20px}}@media only screen and (max-width: 550px){.next-game-values.svelte-1ps5l7l{margin:20px 10px;font-size:0.85em}.next-game-prediction.svelte-1ps5l7l{margin:40px 15px}}",
...
const NextGameStats = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"next-game-prediction svelte-1ps5l7l"}" style="${"border: 6px solid var(--" + escape(oppTeam, true) + ");"}"><div class="${"next-game-title svelte-1ps5l7l"}" style="${"background-color: var(--" + escape(oppTeam, true) + ");"}"><h1 class="${"next-game-title-text svelte-1ps5l7l"}" style="${"color: var(--" + escape(oppTeam, true) + "-secondary);"}">Next Game: 
      <button class="${"next-game-team-btn svelte-1ps5l7l"}">${escape(toAlias(data.upcoming[team].nextTeam))} </button>
      (${escape(data.upcoming[team].atHome ? "Home" : "Away")})
    </h1></div>

  <div class="${"next-game-values svelte-1ps5l7l"}"><div class="${"predictions-and-logo svelte-1ps5l7l"}">${showBadge
	? `<div class="${"next-game-logo opposition-badge svelte-1ps5l7l"}" style="${"background-image: url('" + escape(data.logoURLs[data.upcoming[team].nextTeam], true) + "')"}"></div>`
	: `<div class="${"next-game-position svelte-1ps5l7l"}"></div>`}
      <div class="${"predictions"}"><div class="${"next-game-item svelte-1ps5l7l"}"><div class="${"next-game-position svelte-1ps5l7l"}">${escape(data.standings[data.upcoming[team].nextTeam][data._id].position)}<span class="${"ordinal-position svelte-1ps5l7l"}">${escape(ordinal$1(data.standings[data.upcoming[team].nextTeam][data._id].position))}</span></div></div>
        <div class="${"next-game-item svelte-1ps5l7l"}">Current form:
          ${currentMatchday != null
	? `<b>${escape((data.form[data._id][data.upcoming[team].nextTeam][currentMatchday].formRating5 * 100).toFixed(1))}%</b>`
	: `None`}</div>
        <div class="${"next-game-item svelte-1ps5l7l"}">Score prediction
          <br>
          <a class="${"predictions-link svelte-1ps5l7l"}" href="${"/predictions"}"><b>${escape(Math.round(data.upcoming[team].prediction.homeGoals))} - ${escape(Math.round(data.upcoming[team].prediction.awayGoals))}</b></a>
          <br>
          </div></div></div>
    <div class="${"past-results svelte-1ps5l7l"}">${data.upcoming[team].prevMatches.length == 0
	? `<div class="${"next-game-item prev-results-title no-prev-results svelte-1ps5l7l"}">No Previous Results
        </div>`
	: `<div class="${"next-game-item prev-results-title svelte-1ps5l7l"}">Previous Results</div>`}

      
      ${each(data.upcoming[team].prevMatches, prevMatch => {
		return `<div class="${"next-game-item " + escape(prevMatch.result, true) + " svelte-1ps5l7l"}"><div class="${"past-result svelte-1ps5l7l"}"><div class="${"home-team svelte-1ps5l7l"}">${escape(toAlias(prevMatch.homeTeam))}</div>
            <div class="${"score svelte-1ps5l7l"}">${escape(prevMatch.homeGoals)} - ${escape(prevMatch.awayGoals)}</div>
            <div class="${"away-team svelte-1ps5l7l"}">${escape(toAlias(prevMatch.awayTeam))}</div></div>
          <div style="${"clear: both"}"></div>
          <div class="${"past-result-date svelte-1ps5l7l"}">${escape(new Date(prevMatch.date).toLocaleDateString("en-us", {
			weekday: "long",
			year: "numeric",
			month: "short",
			day: "numeric"
...
${validate_component(Router, "Router").$$render($$result, {}, {}, {
		default: () => {
			return `<div id="${"team"}" class="${"svelte-17g8lyk"}"><div id="${"navBar"}" class="${"svelte-17g8lyk"}">${validate_component(NavBar, "NavBar").$$render(
				$$result,
				{
					team: hyphenatedTeam,
					teams,
    ...
    <div id="${"dashboard"}" class="${"svelte-17g8lyk"}"><div class="${"header svelte-17g8lyk"}" style="${"background-color: var(--" + escape(hyphenatedTeam, true) + ");"}"><a class="${"main-link no-decoration svelte-17g8lyk"}" href="${"/" + escape(hyphenatedTeam, true)}"><div class="${"title svelte-17g8lyk"}" style="${"color: var(--" + escape(hyphenatedTeam + '-secondary', true) + ");"}">${escape(toAlias(team))}</div></a></div>

      ${data != undefined
			? `<div class="${"page-content svelte-17g8lyk"}"><div class="${"row multi-element-row small-bottom-margin svelte-17g8lyk"}">${`<div class="${"row-left position-no-badge svelte-17g8lyk"}"><div class="${"circles-background-container svelte-17g8lyk"}"><svg class="${"circles-background svelte-17g8lyk"}"><circle cx="${"300"}" cy="${"150"}" r="${"100"}" stroke-width="${"0"}" fill="${"var(--" + escape(hyphenatedTeam, true) + "-secondary)"}"></circle><circle cx="${"170"}" cy="${"170"}" r="${"140"}" stroke-width="${"0"}" fill="${"var(--" + escape(hyphenatedTeam, true) + ")"}"></circle><circle cx="${"300"}" cy="${"320"}" r="${"170"}" stroke-width="${"0"}" fill="${"var(--" + escape(hyphenatedTeam, true) + ")"}"></circle></svg></div>
                <div class="${"position-central svelte-17g8lyk"}">${escape(data.standings[team][data._id].position)}</div></div>`}
            <div class="${"row-right fixtures-graph row-graph svelte-17g8lyk"}"><h1 class="${"lowered"}">Fixtures</h1>
              <div class="${"graph mini-graph mobile-margin svelte-17g8lyk"}">${validate_component(Fixtures, "Fixtures").$$render($$result, { data, team }, {}, {})}</div></div></div>

          <div class="${"row multi-element-row svelte-17g8lyk"}"><div class="${"row-left form-details svelte-17g8lyk"}">${validate_component(CurrentForm, "CurrentForm").$$render($$result, { data, currentMatchday, team, toInitials }, {}, {})}
            ...
            <div class="${"row-right svelte-17g8lyk"}">${validate_component(NextGame, "NextGame").$$render(
					$$result,
					{
						data,
						currentMatchday,
          ...
          <div class="${"row svelte-17g8lyk"}"><div class="${"form-graph row-graph svelte-17g8lyk"}"><h1 class="${"lowered"}">Form Over Time</h1>
          ...
          <div class="${"row svelte-17g8lyk"}"><div class="${"position-over-time-graph row-graph svelte-17g8lyk"}"><h1 class="${"lowered"}">Position Over Time</h1>
          ...
          <div class="${"row no-bottom-margin svelte-17g8lyk"}"><div class="${"goals-scored-vs-conceded-graph row-graph svelte-17g8lyk"}"><h1 class="${"lowered"}">Goals Scored and Conceded</h1>
          ...
          <div class="${"row svelte-17g8lyk"}"><div class="${"row-graph svelte-17g8lyk"}"><div class="${"clean-sheets graph full-row-graph"}">${validate_component(CleanSheets, "CleanSheets").$$render($$result, { data, team, playedMatchdays }, {}, {})}</div></div></div>
          
          <div class="${"season-stats-row svelte-17g8lyk"}">${validate_component(SeasonStats, "SeasonStats").$$render($$result, { data, team }, {}, {})}</div>

          <div class="${"row svelte-17g8lyk"}"><div class="${"goals-freq-row row-graph svelte-17g8lyk"}"><h1>Goals Per Game</h1>
              ${validate_component(GoalsPerGame, "GoalsPerGame").$$render($$result, { data, team }, {}, {})}</div></div>

              <div class="${"row svelte-17g8lyk"}"><div class="${"row-graph svelte-17g8lyk"}"><div class="${"score-freq graph svelte-17g8lyk"}">${validate_component(ScoreFreq, "ScoreFreq").$$render($$result, { data, team }, {}, {})}</div></div></div>

          <div class="${"row svelte-17g8lyk"}"><div class="${"spider-chart-row row-graph svelte-17g8lyk"}"><div class="${"spider-chart-container svelte-17g8lyk"}">${validate_component(Spider, "Spider").$$render($$result, { data, team, teams, toAlias, toName }, {}, {})}</div></div></div>

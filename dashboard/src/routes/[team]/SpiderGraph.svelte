<script lang="ts">
	...
	function scaleAttack(attack: SpiderAttribute, range: [number, number]): SpiderAttribute {
	...
	function getAttack(data: TeamsData): SpiderAttribute {
	...
	function concededPerSeason(data: TeamsData): [SpiderAttribute, [number, number]] {
		...
		return [defence as SpiderAttribute, [minConcededPerSeason, maxConcededPerSeason]];
	}

	function scaleDefence(defence: SpiderAttribute, range: [number, number]): SpiderAttribute {
		const [lower, upper] = range;
	...
	function getDefence(data: TeamsData) {
	...
	function formCleanSheets(form: Form, team: Team, season: number): number {
		let nCleanSheets = 0;
	...
	function getCleanSheets(data: TeamsData): SpiderAttribute {
	...
	function formConsistency(form: Form, team: Team, season: number): number {
	...
	function getConsistency(data: TeamsData): SpiderAttribute {
	...
	function formWinStreak(form: Form, team: Team, season: number): number {
		let winStreak = 0;
		let tempWinStreak = 0;
		for (const matchday in form[team][season]) {
			const match = form[team][season][matchday];
	...
	function getWinStreak(data: TeamsData): SpiderAttribute {
	...
	function seasonComplete(data: TeamsData, team: Team, season: number): boolean {
	...
	function getVsBig6(data: TeamsData): SpiderAttribute {
		//@ts-ignore
	...
	function initSpiderPlots(team: Team): [SpiderAttribute, SpiderAttribute] {
